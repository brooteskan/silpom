...
public:
    ...
    static void Reflect(AZ::ReflectContext* context)
    {
        ...
        if(auto* sc=azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            if(auto* edit=sc->GetEditContext())
            {
                edit->Class<EditorMeshComponent>("SilPOM Mesh","Imported static mesh: ordinary faces and curved displaced regions.")
                    ->ClassElement(AZ::Edit::ClassElements::EditorData,"")
                    ->Attribute(AZ::Edit::Attributes::Category,"Graphics")
                    ->Attribute(AZ::Edit::Attributes::AppearsInAddComponentMenu,AZ_CRC_CE("Game"))
                    ->Attribute(AZ::Edit::Attributes::AutoExpand,true)
                ...
                edit->Class<MeshConfig>("Mesh settings","")
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Default,&MeshConfig::m_maxNodes,"Maximum traversal nodes","Unresolved rays display magenta; they are not valid misses")
                    ->DataElement(AZ::Edit::UIHandlers::Default,&MeshConfig::m_maxFragments,"Maximum cooked fragments","Explicit preprocessing/memory budget")
                    ->DataElement(AZ::Edit::UIHandlers::Default,&MeshConfig::m_depthAccuracy,"Depth accuracy (metres)","")
                    ->DataElement(AZ::Edit::UIHandlers::CheckBox,&MeshConfig::m_enableExperimentalRaster,"Enable experimental raster","Opt-in staged compute integration. Bounded ray/view budget; projected-light atlases and MSAA are unsupported. See Docs/ImportedMeshIntegration.md.");
                edit->Class<MeshMaterialBinding>("Material slot","")
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Default,&MeshMaterialBinding::m_material,"Material","StandardPBR material; curved variant is managed automatically");
