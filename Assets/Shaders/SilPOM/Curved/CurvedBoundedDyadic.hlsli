...
#pragma once
#if defined(__cplusplus) && !defined(SILPOM_AZSL)
// C++ consumers supply standard-library headers in their adapter. Keeping
// them out of shader assets avoids false Asset Processor include dependencies.
